...
const items:string[]=['Bread','Milk','Butter','water']
console.log("item in the array:", items.includes('Bread')); // true

// wether an items is not in array
console.log("item is not in the array:", items.includes('ColdDrink')); // flase